...
WebDriver driver;
    ...
    public void mainTest() throws InterruptedException {
	  ...
	  // Locate the "Add New" button and click 
	     ...
	     //String mainmenu = driver.findElement(By.xpath("//div[contains(text(),'Job Listing')]")).getText(); //Locating the Job Listing
	   ...
	   //WebElement position = driver.findElement(By.xpath("//div[contains(@class, 'wp-block-freeform')]"));
