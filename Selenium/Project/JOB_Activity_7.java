...
WebDriver driver;
    ...
    public static Object[][] credentials() {
        return new Object[][] { { "Manjula_10@in.ibm.com", "Test Manager", "MN@ibm.com", "IBM India" }};
	}

	@Test (dataProvider = "Form_Data")
    public void mainTest(String email, String JobTitle, String WebID, String CompanyName) {
	    ...
	    //String postMgs = driver.findElement(By.xpath("//div[@class='enter-content clear]")).getText();
	    //System.out.println(postMgs);
